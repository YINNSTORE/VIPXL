...
REPO="https://raw.githubusercontent.com/YINNSTORE/VIPXL/main/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/YINNSTORE/VIPXL/main/ip | grep $MYIP | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/YINNSTORE/VIPXL/main/ip | grep $MYIP | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ORDER🐳","url":"https://t.me/YinnVpn"},{"text":"GROUP🐬","url":""}]]}'
...
wget raw.githubusercontent.com/zhets/xdvip/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
